...
enum MenuBarIconState: Equatable {
    ...
    /// The more consequential state wins: a Mac that can't sleep at all matters more than one that
    /// merely won't idle out.
    static func current(keepAwakeRunning: Bool, systemSleepDisabled: Bool) -> MenuBarIconState {
